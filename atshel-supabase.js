 ...
 *
 * SEGURIDAD CRÍTICA:
 *   - El logout ejecuta powersync.disconnect() + powersync.clearStorage()
 *     antes de redirigir. Sin esto, datos de una empresa quedan en el
 *     dispositivo si el celular es compartido o extraviado.
 *   - NUNCA usar la service_role key aquí. Solo la anon key pública.
 *   - Las credenciales vienen de variables de entorno de Vite (VITE_*).
 *     En desarrollo, crear un archivo .env.local (nunca commitear al repo).
 */
